...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Smartcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
	{"smartcoin.cc", "dnsseed.smartcoin.cc"},
	{"lavastorm.net", "dnsseed.lavastorm.net"},
	{"seed.getsmartcoin.com", "seed.getsmartcoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
	{"smartcoin.cc", "testnet-seed.smartcoin.cc"},
	{"lavastorm.net", "testnet-seed.lavastorm.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Smartcoin is probably already running."), addrBind.ToString().c_str());
        else
